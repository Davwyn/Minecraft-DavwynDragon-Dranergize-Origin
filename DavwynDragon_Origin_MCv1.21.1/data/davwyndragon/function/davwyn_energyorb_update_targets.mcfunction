...
tag @e[tag=!energyorb_safe,type=!#davwyndragon:energyorb_nontarget,tag=!DavwynDragonLight,tag=!DavwynDragonLightEven,tag=!DavwynDragonLightOdd,tag=!DavwynDragonGlowEven,tag=!DavwynDragonGlowOdd,tag=!DavwynDragonGlowEven,tag=!DavwynDragonGlowOdd,type=!boat,type=!minecart,type=!arrow,type=!experience_orb] add energyorb_targetable
