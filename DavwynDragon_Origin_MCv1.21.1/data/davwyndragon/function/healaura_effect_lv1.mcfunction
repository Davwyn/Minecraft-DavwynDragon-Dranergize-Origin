...
execute at @s run resource change @e[nbt={cardinal_components:{"apoli:powers":{"powers":[{id:"davwyndragon:healaura_toggle",data:1}]}}},type=player,distance=..2.0,sort=nearest,limit=1] davwyndragon:mana_resource -5
execute at @s run xp add @e[nbt={cardinal_components:{"apoli:powers":{"powers":[{id:"davwyndragon:healaura_toggle",data:1}]}}},type=player,distance=..2.0,sort=nearest] 1
