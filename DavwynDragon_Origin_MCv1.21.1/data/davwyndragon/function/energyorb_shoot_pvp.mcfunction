...
execute as @s positioned ^ ^1 ^ if entity @e[tag=energyorb_targetable,distance=..10.0,sort=nearest,nbt={DeathTime:0s},limit=1] as @e[distance=..6.0,nbt={cardinal_components:{"apoli:powers":{"powers":[{id:"davwyndragon:shake_effect_resource"}]}}}] if entity @s run resource set @s davwyndragon:shake_effect_resource 2
...
execute at @s positioned ^ ^1 ^ as @e[tag=energyorb_targetable,distance=..10.0,sort=nearest,nbt={DeathTime:0s},limit=1] if entity @s at @s as @e[distance=..6.0,nbt={cardinal_components:{"apoli:powers":{"powers":[{id:"davwyndragon:shake_effect_resource"}]}}}] if entity @s run resource set @s davwyndragon:shake_effect_resource 2
