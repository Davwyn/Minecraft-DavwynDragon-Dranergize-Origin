...
execute as @s positioned ^ ^1 ^ if entity @e[tag=energyorb_targetable,distance=..10.0,sort=nearest,nbt={DeathTime:0s},limit=1] as @e[distance=..6.0,nbt={cardinal_components:{"apoli:powers":{"powers":[{id:"futaradragon:shake_effect_resource"}]}}}] if entity @s run resource set @s futaradragon:shake_effect_resource 2
execute as @s positioned ^ ^1 ^ if entity @e[tag=energyorb_targetable,distance=..10.0,sort=nearest,nbt={DeathTime:0s},limit=1] as @e[distance=..6.0,nbt={cardinal_components:{"apoli:powers":{"Powers":[{Type:"futaradragon:shake_effect_resource"}]}}}] if entity @s run resource set @s futaradragon:shake_effect_resource 2
execute as @s positioned ^ ^1 ^ if entity @e[tag=energyorb_targetable,distance=..10.0,sort=nearest,nbt={DeathTime:0s},limit=1] as @e[distance=..6.0,nbt={ForgeCaps:{"apoli:powers":{"Powers":[{Type:"futaradragon:shake_effect_resource"}]}}}] if entity @s run resource set @s futaradragon:shake_effect_resource 2
...
execute at @s positioned ^ ^1 ^ as @e[tag=energyorb_targetable,distance=..10.0,sort=nearest,nbt={DeathTime:0s},limit=1] if entity @s at @s as @e[distance=..6.0,nbt={cardinal_components:{"apoli:powers":{"powers":[{id:"futaradragon:shake_effect_resource"}]}}}] if entity @s run resource set @s futaradragon:shake_effect_resource 2
execute at @s positioned ^ ^1 ^ as @e[tag=energyorb_targetable,distance=..10.0,sort=nearest,nbt={DeathTime:0s},limit=1] if entity @s at @s as @e[distance=..6.0,nbt={cardinal_components:{"apoli:powers":{"Powers":[{Type:"futaradragon:shake_effect_resource"}]}}}] if entity @s run resource set @s futaradragon:shake_effect_resource 2
execute at @s positioned ^ ^1 ^ as @e[tag=energyorb_targetable,distance=..10.0,sort=nearest,nbt={DeathTime:0s},limit=1] if entity @s at @s as @e[distance=..6.0,nbt={ForgeCaps:{"apoli:powers":{"Powers":[{Type:"futaradragon:shake_effect_resource"}]}}}] if entity @s run resource set @s futaradragon:shake_effect_resource 2

execute at @s positioned ^ ^1 ^ as @e[tag=energyorb_targetable,distance=..10.0,sort=nearest,nbt={DeathTime:0s},limit=1] if entity @s at @s as @e[type=!player,tag=energyorb_targetable,distance=..1.5,sort=nearest,nbt={DeathTime:0s},nbt={DeathTime:0s}] if entity @s as @e[tag=energizedragon,type=player,distance=..40.0] as @s at @s run xp add @s 1
# Added fire effect to starwisps -Davwyn
execute at @s positioned ^ ^1 ^ as @e[tag=energyorb_targetable,distance=..10.0,sort=nearest,nbt={DeathTime:0s},limit=1] if entity @s at @s as @e[tag=energyorb_targetable,distance=..1.5,sort=nearest,nbt={DeathTime:0s}] if entity @s at @s run data modify entity @s Fire set value 20s
# ---
...
execute as @s positioned ^ ^1 ^5 if entity @e[tag=energyorb_targetable,distance=..5.0,sort=nearest,nbt={DeathTime:0s},limit=1] at @s run resource set @e[tag=dragonattacking,type=player,distance=..20.0,sort=nearest,limit=1] davwyndragon:energyorb_mode 1
